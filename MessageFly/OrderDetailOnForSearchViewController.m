//
//  OrderDetailOnForSearchViewController.m
//  MessageFly
//
...
#import "MoveView.h"
@interface OrderDetailOnForSearchViewController ()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate>
{
...
@implementation OrderDetailOnForSearchViewController
...
-(void)makeUI
{
    ...
    firstView = [[UIView alloc]initWithFrame:CGRectMake(0, 10, WIDTH, 550)];
    ...
    secView = [MyControll createToolView4WithFrame:CGRectMake(0, 445 +140, WIDTH, 160) withColor:[UIColor whiteColor] withNameArray:@[@"酬      金:",@"剩余时长:",@"投放地址:",@"已抢/发布:"]];
    ...
    thirdView = [[UIView alloc]initWithFrame:CGRectMake(0, 615, WIDTH, 40)];
