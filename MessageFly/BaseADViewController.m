...
- (void)viewDidLoad
{
    ...
    voiceArray = @[@"record_animate_01",@"record_animate_02",@"record_animate_03",@"record_animate_04",@"record_animate_05",@"record_animate_06",@"record_animate_07",@"record_animate_08",@"record_animate_09",@"record_animate_10",@"record_animate_11",@"record_animate_12",@"record_animate_13",@"record_animate_14"];

    
    
    mbLightNav = YES;
    mFontSize = 20;
    self.mTopImage = [UIImage imageNamed:IOS_7?@"4":@"4"];
...
-(void)showVoiceLoadingView
{
    ...
    voiceLoadView =[[MBProgressHUD alloc] initWithView:self.view];
    [voiceLoadView show:YES];
    [self.view addSubview:voiceLoadView];
