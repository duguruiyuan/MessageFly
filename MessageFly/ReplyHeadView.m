...
-(void)makeUI
{
    ...
    UILabel *t = [MyControll createLabelWithFrame:CGRectMake(20, 10, 150, 20) title:@"抢单人回复" font:18];
...
-(void)config:(NSDictionary *)dic
{
    ...
    if (![dic[@"radio"] isEqualToString:@""]) {
        ...
        height = voiceView.frame.origin.y+voiceView.frame.size.height+10;
    }
    else
    {
