...
@interface MyPressViewController ()<UIScrollViewDelegate>
{
...
-(void)makeUI
{
    ...
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(reloadSubViewcontroll) name:PressRELOADVC object:nil];
