...
@interface LoseEffectViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    UIView *bgView;
...
@implementation LoseEffectViewController
...
-(void)makeUI
{
    ...
    secView = [MyControll createToolView4WithFrame:CGRectMake(0, 365, WIDTH, 160) withColor:[UIColor whiteColor] withNameArray:@[@"酬      金:",@"剩余时长:",@"投放地址:",@"抢单状态:"]];
