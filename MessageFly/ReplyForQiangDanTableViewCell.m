//
//  ReplyForQiangDanTableViewCell.m
//  MessageFly
//
...
@implementation ReplyForQiangDanTableViewCell
...
-(void)makeUI
{
    ...
    t = [MyControll createLabelWithFrame:CGRectMake(20, 10, 150, 20) title:@"我的回复" font:18];
...
-(void)config:(NSDictionary *)dic
{
    ...
    if ([dic[@"whosereply"] isEqualToString:@"myreply"]) {
        t.text = @"我的回复";
    }
    else
    {
