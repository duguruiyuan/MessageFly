//
//  StrikeDealMyOrderViewController.m
//  MessageFly
//
...
@interface StrikeDealMyOrderViewController ()<UIAlertViewDelegate>
{
    UIScrollView *mainSC;
...
@implementation StrikeDealMyOrderViewController
...
-(void)makeUI
{
    ...
    stausLabel = [MyControll createLabelWithFrame:CGRectMake(WIDTH-100, 120, 90, 40) title:@"已成交" font:15];
